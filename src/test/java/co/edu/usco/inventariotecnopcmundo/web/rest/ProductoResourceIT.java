...
class ProductoResourceIT {
    ...
    public static Producto createEntity(EntityManager em) {
        Producto producto = new Producto().nombre(DEFAULT_NOMBRE).cantidad(DEFAULT_CANTIDAD);
        return producto;
    }
    ...
    public static Producto createUpdatedEntity(EntityManager em) {
        Producto producto = new Producto().nombre(UPDATED_NOMBRE).cantidad(UPDATED_CANTIDAD);
        return producto;
    }
    ...
    void putNewProducto() throws Exception {
        ...
        updatedProducto.nombre(UPDATED_NOMBRE).cantidad(UPDATED_CANTIDAD);
    ...
    void partialUpdateProductoWithPatch() throws Exception {
        ...
        partialUpdatedProducto.nombre(UPDATED_NOMBRE).cantidad(UPDATED_CANTIDAD);
