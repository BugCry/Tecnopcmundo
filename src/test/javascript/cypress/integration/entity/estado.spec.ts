...
describe('Estado e2e test', () => {
  ...
  it('should load details Estado page', function () {
  ...
  it('should load edit Estado page', function () {
    cy.visit(estadoPageUrl);
    cy.wait('@entitiesRequest').then(({ response }) => {
      if (response.body.length === 0) {
        this.skip();
  ...
  it('should create an instance of Estado', () => {
    ...
    cy.get(`[data-cy="nombre"]`).type('algoritmo value-added').should('have.value', 'algoritmo value-added');
  ...
  it('should delete last instance of Estado', function () {
    cy.visit(estadoPageUrl);
    cy.wait('@entitiesRequest').then(({ response }) => {
      if (response.body.length > 0) {
