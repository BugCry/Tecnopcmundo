...
describe('Component Tests', () => {
  describe('EstadoPublicacion Management Component', () => {
    let comp: EstadoPublicacionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EstadoPublicacionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.estadoPublicacions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
