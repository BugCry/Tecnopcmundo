...
describe('Component Tests', () => {
  describe('DetallesUsuario Management Component', () => {
    let comp: DetallesUsuarioComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DetallesUsuarioComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.detallesUsuarios?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
