...
import co.edu.usco.inventariotecnopcmundo.service.ProveedorService;
...
/**
 * REST controller for managing {@link co.edu.usco.inventariotecnopcmundo.domain.Proveedor}.
 */
@RestController
@RequestMapping("/api")
